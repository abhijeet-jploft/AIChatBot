...
function buildAiPayload(company) {
  ...
  return {
    ...
    hasLiveAvatarKey: Boolean(String(company?.liveavatar_api_key || '').trim()),
...
async function updateSettings(req, res) {
  try {
    ...
    await CompanyAdmin.updateSettings(req.adminCompanyId, {
      ...
      liveavatar_api_key: ai?.liveAvatarApiKey !== undefined ? (String(ai.liveAvatarApiKey || '').trim() || null) : undefined,
