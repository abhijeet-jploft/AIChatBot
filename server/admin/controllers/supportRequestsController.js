const { list: listSupportRequests } = require('../../services/supportRequestsStore');
...
async function listSupportRequestsHandler(req, res) {
  try {
    ...
    const result = listSupportRequests(companyId, { limit, offset });
    ...
    const rows = result.rows.map((r) => ({
      ...r,
      firstMessage: firstMessageBySession.get(r.sessionId) || r.message,
    }));
...
module.exports = { listSupportRequestsHandler };
